...
par(mfrow = c(2, 1))
plot(data[weekend,] %>% group_by(interval) %>% summarise(interval.mean = mean(steps, na.rm = TRUE)), type = "l", main = "Weekend", ylab = "Interval Mean", xlab = "Time of Day")
plot(data[!weekend,] %>% group_by(interval) %>% summarise(interval.mean = mean(steps, na.rm = TRUE)), type = "l", main = "Weekday", ylab = "Interval Mean", xlab = "Time of Day")
```
